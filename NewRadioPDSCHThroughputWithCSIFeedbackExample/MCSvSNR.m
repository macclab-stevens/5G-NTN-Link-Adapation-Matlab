...
scatter(w2000.eleAnge,w2000.SNR,1)
% scatter(w50.eleAnge,wavg50,1,[0.8500 0.3250 0.0980])
% scatter(w100.eleAnge,wavg100,1,[0.9290 0.6940 0.1250])
% scatter(w200.eleAnge,wavg200,1,[0.4940 0.1840 0.5560])
% scatter(w1000.eleAnge,wavg1000,1,[0.4660 0.6740 0.1880])
...
yyaxis right 
lag = 1;
% ravg10 = movavg(w10.MCS,'simple',lag);
% ravg50 = movavg(w50.MCS,'simple',lag);
% ravg100 = movavg(w100.MCS,'simple',lag);
% ravg200 = movavg(w200.MCS,'simple',lag);
% ravg1000 = movavg(w1000.MCS,'simple',lag);
ravg2000 = movavg(w2000.MCS,'simple',lag);
ravg2005 = movavg(w2005.MCS,'simple',lag);
ravg2010 = movavg(w2010.MCS,'simple',lag);


% scatter(w10.eleAnge,ravg10,1,[0 0.4470 0.7410])
% scatter(w50.eleAnge,ravg50,1,[0.8500 0.3250 0.0980])
% scatter(w100.eleAnge,ravg100,1,[0.9290 0.6940 0.1250])
% scatter(w200.eleAnge,ravg200,1,[0.4940 0.1840 0.5560])
% scatter(w1000.eleAnge,ravg1000,1,[0.4660 0.6740 0.1880])
...
ylim([3,10])
ylabel("Avg MCS Allocation")
hold off

lgd = legend('BLER .01','BLER .05','BLER .10')
lgd.Location = "northwest"
lgd.Title.String = "Target BLER = .01"
